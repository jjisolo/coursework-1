OBJ=source/Main.cxx source/rendering/TextureUtils.cxx source/Window.cxx source/rendering/RenderScene.cxx source/rendering/ShaderManager.cxx source/rendering/GlUtils.cxx vendor/glad.c
